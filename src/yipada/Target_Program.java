...
public class Target_Program {
    ...
    public Target_Program(SymbolTable oSymTable,
    ...
    public boolean GenerateCode(String sAppDir) throws Exception {
        ...
        Debug.println("Output file ::" + sOutPutFile);
        Debug.println("Executable : " + sExecutableFile);
    ...
    private boolean add_a_C_Code2File(Quadruple oQuadruple, int iIndexOfCode) {
        ...
        if (oQuadruple.sOpCode.trim().equals(compiler.s3AddressOperator_CLASS_DEF_BEGIN)) {
            ...
            //
            o3AddressCodeOperand_1 = oQuadruple.sArg_1; // method return type
            o3AddressCodeOperand_2 = oQuadruple.sArg_2; // method name
            // System.out.println(oQuadruple.sArg_1.getIdentification_or_SymbolTanleIndex());
            String sMethodName =
                    oSymbolTable.getSymbolFromIndex(
                    Integer.parseInt(o3AddressCodeOperand_2.getIdentification_or_SymbolTanleIndex()));
            sActiveMethodName = sMethodName;
            String sReturnType = o3AddressCodeOperand_1.getIdentification_or_SymbolTanleIndex();
            sReturnType = "int";
            println(sReturnType + " " + sMethodName + "() {");
            ...
            String sReturnType = o3AddressCodeOperand_1.getIdentification_or_SymbolTanleIndex();
            sReturnType = "int";  // would delete latere
            println("return " + generate_random_return_value(sReturnType)
                    + " ; ");
        ...
        } else if (oQuadruple.sOpCode.trim().equals(compiler.s3AddressOperator_MODULO)) {
            //
            o3AddressCodeOperand_1 = oQuadruple.sArg_1; // l-value
            o3AddressCodeOperand_2 = oQuadruple.sArg_2; // r-value
            translate_arithmeticExpression_2_C(compiler.s3AddressOperator_MODULO,
    ...
    private void translate_arithmeticExpression_2_C(String sArithMeticOperator,
        ...
        if (sArithMeticOperator.trim().equals(compiler.s3AddressOperator_MODULO)) {
            println(sSymbol + "=" + sOperand_1 + "%" + sOperand_2 + ";");
        } else if (sArithMeticOperator.trim().equals(compiler.s3AddressOperator_ADD)) {
            println(sSymbol + "=" + sOperand_1 + "+" + sOperand_2 + ";");
